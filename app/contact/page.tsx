...
import { Mail, Phone, MapPin, Clock, Send, MessageCircle, Globe, Shield, Zap, Users, Building2, CheckCircle, AlertCircle, ArrowLeft, ShoppingCart, Headphones, TrendingUp, Calendar, FileText, Briefcase, CreditCard, Database, Bot, ExternalLink, RefreshCw } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <Card className="shadow-lg border-0">
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  <h3 className="text-lg font-semibold mb-2">Choose Your Contact Method</h3>
                  <p className="text-muted-foreground">Select how you'd like to get in touch with us</p>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs opacity-90">We'll respond within 24 hours</div>
                    </div>
                  </Button>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2">
              ...
              <Card className="shadow-xl border-0 bg-gradient-to-br from-white to-green-50/30 dark:from-card dark:to-green-900/10">
                <CardHeader>
                  ...
                  <CardDescription>
                    Book a consultation call instantly using our Calendly integration. Choose your preferred time and get confirmed immediately.
                  </CardDescription>
                </CardHeader>
