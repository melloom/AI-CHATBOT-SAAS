            ...
            <Card className="shadow-lg border-0">
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">Select how you'd like to schedule your consultation</p>
                </div>
            ...
            <div className="lg:col-span-2">
              ...
              <Card className="shadow-lg border-0">
                <CardHeader>
                  ...
                  <CardDescription>
                    Book your consultation instantly using our Calendly integration. Choose your preferred time and get confirmed immediately.
                  </CardDescription>
                </CardHeader>
